...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while True:
        if who == 0:
            ...
            score0 = score0 + take_turn(st0, score1, dice)
        ...
        if who == 1:
            ...
            score1 = score1 + take_turn(st1, score0, dice)
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if picky_piggy(opponent_score) >= cutoff or (opponent_score >= cutoff and score + picky_piggy(opponent_score) == opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
